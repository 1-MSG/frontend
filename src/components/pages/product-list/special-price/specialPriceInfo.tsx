...
export default function SpecialPriceInfo(props:any) {
    ...
    return (
        <div>
            <div>
                <Image src={bundle.bundle_img_url}
                    alt=''
                    width={390}
                    height={374}
                    className='z-0' />
            ...
            <div className=' relative mt-[-130px] z-10 bg-gradient-to-t bg-white/65 to-90% from-white from-60%'>
                {/* 상단배너 */}
                ...
                <div className='my-[15px] px-[16px]'>
                    <h2 className='text-[24px] font-extrabold tracking-[-0.05rem]'>
                        <span>&#91;{bundle.bundle_brand}&#93;</span>
                        {bundle.bundle_name}
                    </h2>
                    <div className='mt-[8px] text-[24px] font-bold'>
                        <em className='not-italic'>{priceToString(bundle.bundle_price)}</em>
                        <span>원~</span>
                    </div>
                </div>
