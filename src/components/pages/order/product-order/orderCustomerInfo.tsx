        ...
        <div className="mt-[20px] pt-[20px] px-[16px] pb-[20px] bg-white rounded-xl">
            ...
            <div className="text-[14px] tracking-[-0.1rem]">
                <dl className="table">
                    ...
                    <input name="" readOnly value={data.userName} className="table-cell pl-[60px]"/>
                </dl>
                <dl className="table mt-[5px]">
                    <dt className="table-cell text-[#888888]">연락처</dt>
                    <input name="" readOnly value={data.phoneNumber} className="table-cell pl-[72px]"/>
                </dl>
                <dl className="table mt-[5px]">
                    <dt className="table-cell text-[#888888]">이메일</dt>
                    <input name="" readOnly value={data.email} className="table-cell pl-[72px]"/>
                </dl>
                <dl className="table mt-[5px]">
