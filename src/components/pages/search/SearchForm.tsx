...
function SearchForm() {
    ...
    // const handleInputChange = async (event: { target: { value: React.SetStateAction<string>; }; }) => {
    //     setSearchText(event.target.value);
    //     {/* API 통신 필요*/ }
    //     console.log(searchText);
        ...
        useEffect(() => {
            ...
            //     try {
            //         const response = await fetch(`${process.env.API_BASE_URL}/search-list?keyword=${searchText}`, {
            //             method: "GET",
            //             headers: {
