...
export default async function Page() {
    ...
    return (
        <>
            <div
                className="w-full flex justify-between items-center py-[8px] pl-[16px] pr-[10px] gap-3"
            ...
            <div className="text-center py-[12px] mb-[20px]">
                <Link
                    href="/nonUser/inquiry"
                    className="inline-block pt-[5px] text-center text-[12px]"
                >
                    <span className="float-left pr-[5px] text-[#9b9b9b]">
                        비회원 조회하기
                    </span>
                </Link>
            </div>
